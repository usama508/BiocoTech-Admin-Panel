...
import list from "../../Components/ChecklistData";
          ...
          >
            <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
              ...
              <nav className="mt-5 flex-1 space-y-1 bg-cyan-600 px-2">
                ...
                >
                  <TbCheckbox className="mr-1  text-white text-xl" />
                  ...
                  <div className="sm:flex sm:items-center  ">
                    ...
                    <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none font-abc">
                      <button
                        ...
                        className="inline-flex items-center justify-center font-light rounded-md border border-transparent bg-cyan-600 text-white hover:bg-cyan-700 px-4 py-2 text-xs shadow-sm  focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2   sm:w-auto"
                      >
                      ...
                      <table className="min-w-full divide-y divide-gray-300">
                        <thead className="bg-lime-500">
                          <tr>
                            <th
                              scope="col"
                              className="py-3.5 font-light pl-4 pr-3 text-left text-sm  text-white sm:pl-6"
                            >
                              List of Checklists
                            </th>
                        ...
                        {loading ? <tbody className="divide-y  divide-gray-200 bg-lime-50">
                          {items.map((list) => (
                            <tr key={list.text}>
                              <td className="whitespace-nowrap font-thin py-4 pl-4 pr-3 text-sm  text-gray-500 sm:pl-6 contentEditable:outline-none">
                              ...
                              <td className="  flex relative font-abc float-right whitespace-nowrap py-7  pl-4 pr-3 text-black  text-sm font-thin sm:pr-6">
                              ...
                              */}
                                ...
                                >
                                  <div>
                                    {check_list_edit.list === null
                                      ? <><div className="flex ">
                                        <div className="cursor-pointer text-lg text-gray-700 "><CiEdit className="text-gray-700 " /> </div>
                                        <div className="text-lg cursor-pointer text-gray-700 ml-1"><RiDeleteBin5Line
                                      ...
                                      : check_list_edit.list === list.text &&
                                        ...
                                        : <>
                                        <div className="flex">
                                        <div className="text-gray-700 text-lg cursor-pointer"><CiEdit /> </div>
                                        <div className="text-gray-700 text-lg cursor-pointer ml-1"><RiDeleteBin5Line
                        ...
                        {showform ? (<div className="flex"><input
                          ...
                          className="block w-full font-thin  ml-7 rounded-md mt-2.5 mb-2.5 border-gray-300 shadow-sm focus:border-lime-500 focus:ring-lime-500 sm:text-sm"
                        ...
                        /><span className="  flex flex-shrink-0 space-x-4">
                            <button
                              ...
                              type="button"
                              className="rounded-md ml-12 bg-white  text-sm text-cyan-600 hover:text-cyan-500 font-thin"
                            >
